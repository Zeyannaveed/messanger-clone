...
export const ConversationList: React.FC<ConversationListProps> = ({
  ...
  const { conversationId, isOpen } = useConversaton();
    ...
    >
      <div className="px-5">
        <div className="flex justify-between mb-4 pt-4">
          ...
          <div onClick={()=>setModelOpen(true)} className="rounded-full p-2 bg-gray-100 text-gray-600 cursor-pointer hover:opacity-75 transition">
